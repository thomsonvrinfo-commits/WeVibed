...
export const pricing = [
  {
    name: "Foundation", price: "$499", period: "project", popular: false,
    desc: "For businesses establishing their first digital presence system.",
    features: ["5-page custom website", "Mobile-first responsive design", "Google Business setup", "Basic SEO foundation", "WhatsApp integration", "Contact & lead forms", "Cloudflare hosting (1 year)", "2-week delivery"],
    timeline: "2 weeks", support: "30 days post-launch",
  },
  {
    name: "Growth", price: "$1,499", period: "project", popular: true,
    desc: "For growing businesses that need a complete business system.",
    features: ["Up to 15 pages", "Premium custom design", "Advanced SEO + analytics", "AI chatbot integration", "CRM + automation setup", "Review & trust system", "Lead generation funnels", "WhatsApp business automation", "Unlimited revisions", "3-month priority support"],
    timeline: "4 weeks", support: "3 months priority",
  },
  {
    name: "Transformation", price: "$3,999", period: "project", popular: false,
    desc: "For established brands demanding a complete digital operating system.",
    features: ["Unlimited pages", "Complete business system", "Full automation suite", "Advanced AI integration", "Custom dashboards & reporting", "Continuous growth system", "Dedicated system manager", "Industry playbook integration", "12-month premium support", "Monthly performance reviews"],
    timeline: "6-8 weeks", support: "12 months premium",
  },
];
